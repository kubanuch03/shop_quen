...
ProductUpdateApiView, ListOneProducApiView, ProductBySubCategory, ColorCreateView, SizeCreateView)
...
urlpatterns = [
    ...
    path('create/sizes/', SizeCreateView.as_view()),
    path('create/colors/', ColorCreateView.as_view()),
]