...
from app_account.views import UserInfoApiView, LogoutView, PaymentMethodApiView, SendResetAPiView, ChangePasswordAPIVIew, ChangeUserInfoApiView, HistoryCreateApiView, HistoryListApiView
